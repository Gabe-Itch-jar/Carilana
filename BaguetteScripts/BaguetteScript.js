...
script.registerModule({
    ...
    module.on("enable", function () {
      Chat.print("§c§lHello there! We have finally made a GitHub and started the process of seperating modules! So go to our github, and download the module you need, to avoid this message. Thanks! discord.io/redesky")
